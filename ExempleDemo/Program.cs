...
// type numerique plus gros : long
string texte = "voici un texte";

string result = texte.Substring(9); //à partir de ou selectionner le texte -> texte
string result2 = texte.Substring(0,5); //à partir de ou et combien -> voici



// Transformer un compte bancaire BBAN Belge (xxx-xxxxxxx-xx) en IBAN
//(BExx-xxxx-xxxx-xxxx). Trouvez la démarche via un moteur de recherche.
